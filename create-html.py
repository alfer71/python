...
date_directory = f'/tmp/html-report/hbu/{date_str}'
index_file_path = '/tmp/html-report/hbu/index.html'
dest_path = '/shared/html-report/hbu'
...
index_content += f"<h1>HBU Servers HTML Report for {date_str}</h1>\n<ul>\n"
...
shutil.copytree('/tmp/html-report/hbu', '/shared/html-report/hbu', dirs_exist_ok=True)
